        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    @role(['admin', 'staff'])
                    <flux:navlist.item icon="home" :href="route('criterias.index')" :current="request()->routeIs('criteria')" wire:navigate>{{ __('Criteria') }}</flux:navlist.item>
                    <flux:navlist.item icon="home" :href="route('questions.index')" :current="request()->routeIs('question')" wire:navigate>{{ __('Question') }}</flux:navlist.item>
